...
//    float scaleFactor; //scale
    xPos = ofGetWidth()/2;
    yPos = ofGetHeight()/2;
    leafLength = ofRandom(10, 150);
    leafWidth = ofRandom(10,280);
    stemLength = ofRandom(30,160);
    stemWidth = ofRandom(3,6);
    rotation = ofRandom(0,360);
    leafColor = ofColor(ofRandom(100,170), ofRandom(50,230), ofRandom(0,20), ofRandom(105,250));
    stemColor = ofColor(90, 73, 9); //hopefully brown
